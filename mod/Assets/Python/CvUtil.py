...
def CvAddBuilding(pCity, CvBuildingClass):
	# Add specified building to specified City
	iBuilding = gc.getInfoTypeForString(CvBuildingClass)
...
#RevDCMReligionControl

def OwnsHolyCity(iPlayer):
	#Checks to see if player has a Holy City
