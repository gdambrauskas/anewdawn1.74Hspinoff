...
/*                                                                                              */
/************************************************************************************************/
	bool electionLandslideVictory(CvPopup* pPopup, CvPopupInfo &info);
	bool electionVictory(CvPopup* pPopup, CvPopupInfo &info);
	bool electionDefeat(CvPopup* pPopup, CvPopupInfo &info);
	bool electionFakeVictory(CvPopup* pPopup, CvPopupInfo &info);
	bool electionFraudDefeat(CvPopup* pPopup, CvPopupInfo &info);
	bool election(CvPopup* pPopup, CvPopupInfo &info);
	bool chooseCurrency(CvPopup* pPopup, CvPopupInfo &info);
