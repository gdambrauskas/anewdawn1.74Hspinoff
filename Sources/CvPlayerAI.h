...
/************************************************************************************************/
	...
	void AI_findBestCivics(CivicTypes* paeBestCivics, CivicTypes* paeBestFixedBordersCivics, int* paiBestValues, int* paiBestFixedBordersValues) const;
	bool containFixedBorders(CivicTypes* paeCivics) const;
