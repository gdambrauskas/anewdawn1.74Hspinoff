...
/************************************************************************************************/
	...
	int getDCM_BATTLE_EFFECTS();
	int getDCM_AIR_BOMBING();
	int getDCM_CIV_CUSTOMISER();
	int getDCM_RANGE_BOMBARD();
	int getDCM_ATTACK_SUPPORT(); // RevolutionDCM
	int getDCM_CIV_CHANGER();
	int getDCM_STACK_ATTACK();
	int getDCM_OPP_FIRE();
	int getDCM_ACTIVE_DEFENSE();
	int getDCM_ARCHER_BOMBARD();
	int getDCM_FIGHTER_ENGAGE();
	// Dale - DCM: Globals END
	// Dale - CCH: Globals START
	int getDCM_CIV_CHANGER_MODE();
	int getDCM_CIV_CHANGER_CHANGES();
...
/************************************************************************************************/
	// Dale - DCM: Globals START
	int m_iDCM_BATTLE_EFFECTS;
	int m_iDCM_AIR_BOMBING;
	int m_iDCM_CIV_CUSTOMISER;
	int m_iDCM_RANGE_BOMBARD;
	int m_iDCM_ATTACK_SUPPORT; // RevolutionDCM
	int m_iDCM_CIV_CHANGER;
	int m_iDCM_STACK_ATTACK;
	int m_iDCM_OPP_FIRE;
	int m_iDCM_ACTIVE_DEFENSE;
	int m_iDCM_ARCHER_BOMBARD;
	int m_iDCM_FIGHTER_ENGAGE;
	// Dale - DCM: Globals END
	// Dale - CCH: Globals START
	int m_iDCM_CIV_CHANGER_MODE;
	int m_iDCM_CIV_CHANGER_CHANGES;
	// Dale - CCH: Globals END
/************************************************************************************************/
/* DCM                                     END                                     Johny Smith  */
/************************************************************************************************/
