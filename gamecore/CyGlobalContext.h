...
/************************************************************************************************/
	...
	int getDCM_BATTLE_EFFECTS() const { return GC.getDCM_BATTLE_EFFECTS(); }
	int getDCM_AIR_BOMBING() const { return GC.getDCM_AIR_BOMBING(); }
	int getDCM_RANGE_BOMBARD() const { return GC.getDCM_RANGE_BOMBARD(); }
	int getDCM_ATTACK_SUPPORT() const { return GC.getDCM_ATTACK_SUPPORT(); } // RevolutionDCM
	int getDCM_CIV_CHANGER() const { return GC.getDCM_CIV_CHANGER(); }
	int getDCM_STACK_ATTACK() const { return GC.getDCM_STACK_ATTACK(); }
	int getDCM_OPP_FIRE() const { return GC.getDCM_OPP_FIRE(); }
	int getDCM_ACTIVE_DEFENSE() const { return GC.getDCM_ACTIVE_DEFENSE(); }
	int getDCM_ARCHER_BOMBARD() const { return GC.getDCM_ARCHER_BOMBARD(); }
	int getDCM_FIGHTER_ENGAGE() const { return GC.getDCM_FIGHTER_ENGAGE(); }
	// Dale - DCM: Globals END
	// Dale - CCH: Globals START
	int getDCM_CIV_CHANGER_MODE() const { return GC.getDCM_CIV_CHANGER_MODE(); }
	int getDCM_CIV_CHANGER_CHANGES() const { return GC.getDCM_CIV_CHANGER_CHANGES(); }
