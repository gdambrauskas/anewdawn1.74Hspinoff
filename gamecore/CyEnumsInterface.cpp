...
// BUG - Sentry Actions - end
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_PANDEMIA", WIDGET_HELP_PANDEMIA)
		// MOD - END - Pandemics
...
// RevolutionDCM End
		...
		.value("GAMEOPTION_DYNAMIC_CIV_NAMES", GAMEOPTION_DYNAMIC_CIV_NAMES)
...
/************************************************************************************************/
		...
		.value("GAMEOPTION_DARK_AGES", GAMEOPTION_DARK_AGES)
		...
		.value("GAMEOPTION_ELECTIONS", GAMEOPTION_ELECTIONS)
		...
		.value("GAMEOPTION_CASTLES", GAMEOPTION_CASTLES)
		.value("GAMEOPTION_ARCTIC_AND_PARKS", GAMEOPTION_ARCTIC_AND_PARKS)
		.value("GAMEOPTION_METEOROLOGY", GAMEOPTION_METEOROLOGY)
		.value("GAMEOPTION_CIVIC_BUILDINGS", GAMEOPTION_CIVIC_BUILDINGS)
		.value("GAMEOPTION_EARLY_BUILDINGS", GAMEOPTION_EARLY_BUILDINGS)
		.value("GAMEOPTION_HISTORICAL_WONDERS", GAMEOPTION_HISTORICAL_WONDERS)
		.value("GAMEOPTION_GUILDS", GAMEOPTION_GUILDS)
		.value("GAMEOPTION_MODERN_CORPORATIONS", GAMEOPTION_MODERN_CORPORATIONS)
/************************************************************************************************/
/* Afforess						          END                                                */
/************************************************************************************************/
...
/************************************************************************************************/
/* Afforess	                  Start		 07/13/10                                               */
/*                                                                                              */
/*                                                                                              */
/************************************************************************************************/
		.value("PLAYEROPTION_IGNORE_DANGER", PLAYEROPTION_IGNORE_DANGER)
		.value("PLAYEROPTION_AVOID_BARBARIANS", PLAYEROPTION_AVOID_BARBARIANS)
		.value("PLAYEROPTION_AUTOMATED_AIR_CAN_REBASE", PLAYEROPTION_AUTOMATED_AIR_CAN_REBASE)
		.value("PLAYEROPTION_AUTOMATED_AIR_CAN_DEFEND", PLAYEROPTION_AUTOMATED_AIR_CAN_DEFEND)
		.value("PLAYEROPTION_NO_EXPLORER_HEALING", PLAYEROPTION_NO_EXPLORER_HEALING)
		.value("PLAYEROPTION_BORDER_STAY_IN_BORDERS", PLAYEROPTION_BORDER_STAY_IN_BORDERS)
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
