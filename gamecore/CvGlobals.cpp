...
m_iDCM_BATTLE_EFFECTS(0),
m_iDCM_AIR_BOMBING(0),
m_iDCM_CIV_CUSTOMISER(0),
m_iDCM_RANGE_BOMBARD(0),
m_iDCM_ATTACK_SUPPORT(0), // RevolutionDCM
m_iDCM_CIV_CHANGER(0),
m_iDCM_STACK_ATTACK(0),
m_iDCM_OPP_FIRE(0),
m_iDCM_ACTIVE_DEFENSE(0),
m_iDCM_ARCHER_BOMBARD(0),
m_iDCM_FIGHTER_ENGAGE(0),
// Dale - DCM: Globals END
// Dale - CCH: Globals START
m_iDCM_CIV_CHANGER_MODE(0),
m_iDCM_CIV_CHANGER_CHANGES(0),
...
bool& CvGlobals::getForceOverwrite()
{
	return m_bForceOverwrite;
}

void CvGlobals::setForceOverwrite(bool newValue)
{
	m_bForceOverwrite = newValue;
}

bool& CvGlobals::getForceDelete()
{
	return m_bForceDelete;
}

void CvGlobals::setForceDelete(bool newValue)
{
	m_bForceDelete = newValue;
}

int& CvGlobals::getForceInsertLocation()
{
	return m_iForceInsertLocation;
}

void CvGlobals::setForceInsertLocation(int newValue)
{
	m_iForceInsertLocation = newValue;
}

void CvGlobals::resetOverwrites()
{
...
/************************************************************************************************/
	...
	m_iDCM_CIV_CUSTOMISER = getDefineINT("DCM_CIV_CUSTOMISER");
	m_iDCM_RANGE_BOMBARD = getDefineINT("DCM_RANGE_BOMBARD");
	m_iDCM_ATTACK_SUPPORT = getDefineINT("DCM_ATTACK_SUPPORT"); // RevolutionDCM
	m_iDCM_CIV_CHANGER = getDefineINT("DCM_CIV_CHANGER");
	...
	// Dale - DCM: Globals END
	// Dale - CCH: Globals START
	m_iDCM_CIV_CHANGER_MODE = getDefineINT("DCM_CIV_CHANGER_MODE");
	m_iDCM_CIV_CHANGER_CHANGES = getDefineINT("DCM_CIV_CHANGER_CHANGES");
	// Dale - CCH: Globals END
/************************************************************************************************/
/* DCM                                     END                                     Johny Smith  */
/************************************************************************************************/
...
/************************************************************************************************/
// Dale - DCM: Pedia Concepts START
int CvGlobals::getNumDCMConceptInfos()
{
...
/*                                                                                              */
/************************************************************************************************/
int CvGlobals::getNumANDConceptInfos()
{
	return (int)m_paANDConceptInfo.size();
}
std::vector<CvInfoBase*>& CvGlobals::getANDConceptInfo()
{
	return m_paANDConceptInfo;
}

CvInfoBase& CvGlobals::getANDConceptInfo(ANDConceptTypes e)
{
	FAssert(e > -1);
...
bool CvGlobals::isBetterRoM() const
{
	return m_bBetterRoMEnabled;
}

bool CvGlobals::isFormationsMod() const
{
	return m_bFormationsMod;
}

bool CvGlobals::isLoadedPlayerOptions() const
{
	return m_bLoadedPlayerOptions;
}

void CvGlobals::setLoadedPlayerOptions(bool bNewVal)
{
...
bool CvGlobals::isXMLLogging()
{
	return m_bXMLLogging;
}

int CvGlobals::getSCORE_FREE_PERCENT()
{
	return m_iSCORE_FREE_PERCENT;
}

int CvGlobals::getSCORE_POPULATION_FACTOR()
{
	return m_iSCORE_POPULATION_FACTOR;
}

int CvGlobals::getSCORE_LAND_FACTOR()
{
	return m_iSCORE_LAND_FACTOR;
}

int CvGlobals::getSCORE_TECH_FACTOR()
{
	return m_iSCORE_TECH_FACTOR;
}

int CvGlobals::getSCORE_WONDER_FACTOR()
{
	return m_iSCORE_WONDER_FACTOR;
}

//New Python Callbacks
int CvGlobals::getUSE_CAN_CREATE_PROJECT_CALLBACK()
{
	return m_iUSE_CAN_CREATE_PROJECT_CALLBACK;
}

int CvGlobals::getUSE_CANNOT_CREATE_PROJECT_CALLBACK()
{
	return m_iUSE_CANNOT_CREATE_PROJECT_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_MELTDOWN_CALLBACK()
{
	return m_iUSE_CAN_DO_MELTDOWN_CALLBACK;
}

int CvGlobals::getUSE_CAN_MAINTAIN_PROCESS_CALLBACK()
{
	return m_iUSE_CAN_MAINTAIN_PROCESS_CALLBACK;
}

int CvGlobals::getUSE_CANNOT_MAINTAIN_PROCESS_CALLBACK()
{
	return m_iUSE_CANNOT_MAINTAIN_PROCESS_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_GROWTH_CALLBACK()
{
	return m_iUSE_CAN_DO_GROWTH_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_CULTURE_CALLBACK()
{
	return m_iUSE_CAN_DO_CULTURE_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_PLOT_CULTURE_CALLBACK()
{
	return m_iUSE_CAN_DO_PLOT_CULTURE_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_PRODUCTION_CALLBACK()
{
	return m_iUSE_CAN_DO_PRODUCTION_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_RELIGION_CALLBACK()
{
	return m_iUSE_CAN_DO_RELIGION_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_GREATPEOPLE_CALLBACK()
{
	return m_iUSE_CAN_DO_GREATPEOPLE_CALLBACK;
}

int CvGlobals::getUSE_CAN_RAZE_CITY_CALLBACK()
{
	return m_iUSE_CAN_RAZE_CITY_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_GOLD_CALLBACK()
{
	return m_iUSE_CAN_DO_GOLD_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_RESEARCH_CALLBACK()
{
...
int CvGlobals::getUSE_AI_UPDATE_UNIT_CALLBACK()
{
	return m_iUSE_AI_UPDATE_UNIT_CALLBACK;
}

int CvGlobals::getUSE_AI_CHOOSE_PRODUCTION_CALLBACK()
{
	return m_iUSE_AI_CHOOSE_PRODUCTION_CALLBACK;
}

int CvGlobals::getUSE_EXTRA_PLAYER_COSTS_CALLBACK()
{
	return m_iUSE_EXTRA_PLAYER_COSTS_CALLBACK;
}

int CvGlobals::getUSE_AI_DO_DIPLO_CALLBACK()
{
	return m_iUSE_AI_DO_DIPLO_CALLBACK;
}

int CvGlobals::getUSE_AI_BESTTECH_CALLBACK()
{
	return m_iUSE_AI_BESTTECH_CALLBACK;
}

int CvGlobals::getUSE_CAN_DO_COMBAT_CALLBACK()
{
	return m_iUSE_CAN_DO_COMBAT_CALLBACK;
}

int CvGlobals::getUSE_AI_CAN_DO_WARPLANS_CALLBACK()
{
...
/* Afforess	                     END                                                            */
/************************************************************************************************/
std::vector<CvInfoBase*>& CvGlobals::getDCMConceptInfo()	// For Moose - XML Load Util, CvInfos
{
	return m_paDCMConceptInfo;
}

CvInfoBase& CvGlobals::getDCMConceptInfo(DCMConceptTypes e)
{
	FAssert(e > -1);
...
// Dale - CCH: Globals START
int CvGlobals::getDCM_CIV_CHANGER_MODE()
{
	return m_iDCM_CIV_CHANGER_MODE;
}

int CvGlobals::getDCM_CIV_CHANGER_CHANGES()
{
	return m_iDCM_CIV_CHANGER_CHANGES;
}
// Dale - CCH: Globals END

// Dale - DCM: Globals START
int CvGlobals::getDCM_BATTLE_EFFECTS()
{
	return m_iDCM_BATTLE_EFFECTS;
}

int CvGlobals::getDCM_AIR_BOMBING()
{
	return m_iDCM_AIR_BOMBING;
}

int CvGlobals::getDCM_CIV_CUSTOMISER()
{
	return m_iDCM_CIV_CUSTOMISER;
}

int CvGlobals::getDCM_RANGE_BOMBARD()
{
	return m_iDCM_RANGE_BOMBARD;
}

// RevolutionDCM - attack support
int CvGlobals::getDCM_ATTACK_SUPPORT()
{
	return m_iDCM_ATTACK_SUPPORT;
}

int CvGlobals::getDCM_CIV_CHANGER()
{
	return m_iDCM_CIV_CHANGER;
}

int CvGlobals::getDCM_STACK_ATTACK()
{
	return m_iDCM_STACK_ATTACK;
}

int CvGlobals::getDCM_OPP_FIRE()
{
	return m_iDCM_OPP_FIRE;
}

int CvGlobals::getDCM_ACTIVE_DEFENSE()
{
	return m_iDCM_ACTIVE_DEFENSE;
}

int CvGlobals::getDCM_ARCHER_BOMBARD()
{
	return m_iDCM_ARCHER_BOMBARD;
}

int CvGlobals::getDCM_FIGHTER_ENGAGE()
{
...
const wchar* CvGlobals::getRankingTextKeyWide(RankingTypes eRanking) const
{
...
const wchar* CvGlobals::parseDenialHover(DenialTypes eDenial)
{
