...
/************************************************************************************************/
		...
		.def("getDCM_BATTLE_EFFECTS", &CyGlobalContext::getDCM_BATTLE_EFFECTS, "int ()")
		.def("getDCM_AIR_BOMBING", &CyGlobalContext::getDCM_AIR_BOMBING, "int ()")
		.def("getDCM_RANGE_BOMBARD", &CyGlobalContext::getDCM_RANGE_BOMBARD, "int ()")
		.def("getDCM_ATTACK_SUPPORT", &CyGlobalContext::getDCM_ATTACK_SUPPORT, "int ()") // RevolutionDCM
		.def("getDCM_CIV_CHANGER", &CyGlobalContext::getDCM_CIV_CHANGER, "int ()")
		.def("getDCM_STACK_ATTACK", &CyGlobalContext::getDCM_STACK_ATTACK, "int ()")
		.def("getDCM_OPP_FIRE", &CyGlobalContext::getDCM_OPP_FIRE, "int ()")
		.def("getDCM_ACTIVE_DEFENSE", &CyGlobalContext::getDCM_ACTIVE_DEFENSE, "int ()")
		.def("getDCM_ARCHER_BOMBARD", &CyGlobalContext::getDCM_ARCHER_BOMBARD, "int ()")
		.def("getDCM_FIGHTER_ENGAGE", &CyGlobalContext::getDCM_FIGHTER_ENGAGE, "int ()")
		// Dale - DCM: Globals END
		// Dale - CCH: Globals START
		.def("getDCM_CIV_CHANGER_MODE", &CyGlobalContext::getDCM_CIV_CHANGER_MODE, "int ()")
		.def("getDCM_CIV_CHANGER_CHANGES", &CyGlobalContext::getDCM_CIV_CHANGER_CHANGES, "int ()")
