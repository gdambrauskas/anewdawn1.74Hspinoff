...
CvTeam::CvTeam() : m_Properties(this)
{
...
/*                                                                                              */
/************************************************************************************************/
							AI_updateBonusValue(pLoopPlot->getBonusType());
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
						}
...
/************************************************************************************************/
					...
					else if(( GC.getGameINLINE().isTechCanFoundReligion(eIndex)) && (GC.getGameINLINE().isOption(GAMEOPTION_LIMITED_RELIGIONS))
#ifdef C2C_BUILD
...
/************************************************************************************************/
	...
	WRAPPER_READ(wrapper, "CvTeam", &m_iNukesValidCount);
	...
	WRAPPER_READ_ARRAY(wrapper, "CvTeam", MAX_TEAMS, m_aiHiredWarAlly);
...
/************************************************************************************************/
	...
	WRAPPER_WRITE(wrapper, "CvTeam", m_iNukesValidCount);
	...
	WRAPPER_WRITE_ARRAY(wrapper, "CvTeam", MAX_TEAMS, m_aiHiredWarAlly);
...
bool CvTeam::isNukesValid() const
{
	return m_iNukesValidCount > 0;
}

void CvTeam::changeNukesValidCount(int iChange)
{
	m_iNukesValidCount += iChange;
}
/************************************************************************************************/
/* Afforess	                  Start		 06/16/10                                               */
/*                                                                                              */
...
void CvTeam::changeTradeModifier(int iChange)
{
	if (iChange != 0)
	{
		...
		for (int iI = 0; iI < MAX_PLAYERS; iI++)
		{
			if (GET_PLAYER((PlayerTypes)iI).getID() == getID() && GET_PLAYER((PlayerTypes)iI).isAlive())
			{
				GET_PLAYER((PlayerTypes)iI).updateTradeRoutes();
			}
		}
