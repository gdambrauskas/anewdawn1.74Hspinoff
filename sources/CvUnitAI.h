...
/************************************************************************************************/
	...
	int AI_attackOddsAtPlot(const CvPlot* pPlot, const CvUnit* pDefender) const;
...
/************************************************************************************************/
	...
	bool AI_workerNeedsToAwaitDefender(CvPlot* pPlot);
	bool processContracts(void);
...
public:
	...
	//	survival odds
	bool exposedToDanger(CvPlot* pPlot, int acceptableOdds) const;
};
