...
/************************************************************************************************/
	...
	bool AI_getVisiblePlotDanger(CvPlot* pPlot, int iRange, bool bAnimalOnly) const;
...
/********************************************************************************/
	...
	int AI_neededHunters(CvArea* pArea) const;
...
/* BETTER_BTS_AI_MOD                       END                                                  */
/************************************************************************************************/
	int	AI_getNumBuildingsNeeded(BuildingTypes eBuilding) const;
...
private:
	...
	int  AI_TechValueCached(TechTypes eTech, bool bAsync, int* paiBonusClassRevealed, int* paiBonusClassUnrevealed, int* paiBonusClassHave) const;
