...
/* Afforess	                     END                                                            */
/************************************************************************************************/
		.def("getCurrentAgeSegment", &CyPlayer::getCurrentAgeSegment, "int ()")
		.def("setCurrentAgeSegment", &CyPlayer::setCurrentAgeSegment, "void (int)")
		.def("getCurrentCulturalAge", &CyPlayer::getCurrentCulturalAge, "int ()")
		.def("setCurrentCulturalAge", &CyPlayer::setCurrentCulturalAge, "void (int)")
