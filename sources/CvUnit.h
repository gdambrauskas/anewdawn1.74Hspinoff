...
public:
	...
	void killUnconditional(bool bDelay, PlayerTypes ePlayer);	//	Used internally
...
/************************************************************************************************/
	...
	virtual int AI_attackOddsAtPlot(const CvPlot* pPlot, const CvUnit* pDefender) const = 0;
