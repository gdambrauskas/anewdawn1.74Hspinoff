...
//	Enable canTrain results to eb cached within a (caller)defined scope
...
/*                                                                                              */
/************************************************************************************************/
	bool canConstruct(BuildingTypes eBuilding, bool bContinue = false, bool bTestVisible = false, bool bIgnoreCost = false, bool bIgnoreAmount = false) const;	// Exposed to Python  
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
	//	KOSHLING - cache can build results
	static void FlushCanConstructCache(BuildingTypes eBuilding = NO_BUILDING);
	bool canConstructInternal(BuildingTypes eBuilding, bool bContinue, bool bTestVisible, bool bIgnoreCost, bool bIgnoreAmount) const;
	void NoteBuildingNoLongerConstructable(BuildingTypes eBuilding) const;

	static CvCity*	g_canConstructCacheCity;
	static std::map<int,bool>* g_bCanConstruct;
...
/************************************************************************************************/
	...
	int foodDifference(bool bBottom = true, bool bIncludeWastage = true) const;								// Exposed to Python
...
//	void changeImprovementYieldChange(ImprovementTypes eIndex1, YieldTypes eIndex2, int iChange);
	...
	void checkBuildings(bool bVicinityBonus = true, bool bCivics = true, bool bWar = true, bool bPower = true, bool bPopulation = true);
...
/********************************************************************************/
	...
	virtual bool AI_isDefended(int iExtra = 0, int iRange = 0) = 0;
/********************************************************************************/
...
/************************************************************************************************/
	mutable std::map< int, std::map<int,int> > m_aCultureDistances;
/************************************************************************************************/
...
private:
	mutable std::map<UnitCombatTypes,bool> m_canTrainCache;
	mutable std::map<UnitTypes,bool> m_canTrainCacheUnits;
...
protected:
	void populateCanTrainCache(void) const;
