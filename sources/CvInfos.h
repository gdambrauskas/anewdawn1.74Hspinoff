...
/************************************************************************************************/
	...
	int getUnitClassStrengthChange(int iUnit) const;
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
public:
	...
	bool changesMoveThroughPlots(void) const;
...
/************************************************************************************************/	
	...
	int getControlPoints() const;
	int getCommandRange() const;
	DllExport const TCHAR* getClassicalArtDefineTag(int i, UnitArtStyleTypes eStyle) const;				// Exposed to Python
	DllExport void setClassicalArtDefineTag(int i, const TCHAR* szVal);
	DllExport const TCHAR* getRennArtDefineTag(int i, UnitArtStyleTypes eStyle) const;				// Exposed to Python
	DllExport void setRennArtDefineTag(int i, const TCHAR* szVal);
	DllExport const TCHAR* getIndustrialArtDefineTag(int i, UnitArtStyleTypes eStyle) const;				// Exposed to Python
...
/********************************************************************************/
	...
	CvOutcomeList* getActionOutcomeList(MissionTypes eMission);
...
/********************************************************************************/
	...
	std::vector<std::pair<MissionTypes,CvOutcomeList> > m_aActionOutcomeList;
};
...
/************************************************************************************************/
	...
	bool isAllowsSlaves() const;
	bool isNoLandmarkAnger() const;
	bool isChooseCurrency() const;
	...
	int getContemporaryFactor() const;
...
/************************************************************************************************/
	...
	int getDarkAgePointsObsolete() const;
	int getDarkAgePointsWeight() const;
...
protected:
	...
	int m_iDarkAgePointsObsolete;
	int m_iDarkAgePointsWeight;
	int m_iLineOfSight;
	int m_iInflationModifier;
	...
	int* m_ppaiTechHappinessChanges;
	int* m_ppaiTechHealthChanges;
...
public:
	...
	int getBonusHappinessChangesVectorSize();
	CvString getBonusHappinessChangesNamesVectorElement(int i);
	int getBonusHappinessChangesValuesVectorElement(int i);
	
	bool isFreePromotionUnitCombats(int i, int j) const;	
//---------------------------------------PROTECTED MEMBER VARIABLES---------------------------------
protected:
	int* m_piBonusHappinessChanges;
	std::vector<CvString> m_aszBonusHappinessChangesforPass3;
	std::vector<int> m_aiBonusHappinessChangesforPass3;
...
/*                                                                                              */
/************************************************************************************************/
	DllExport const TCHAR* getClassicalArtDefineTag(int /*Mesh Index*/ i, int /*UnitType*/ j) const;
	DllExport void setClassicalArtDefineTag(int /*Mesh Index*/ i, int /*UnitType*/ j, const TCHAR* szVal);
	DllExport const TCHAR* getRennArtDefineTag(int /*Mesh Index*/ i, int /*UnitType*/ j) const;
	DllExport void setRennArtDefineTag(int /*Mesh Index*/ i, int /*UnitType*/ j, const TCHAR* szVal);
	DllExport const TCHAR* getIndustrialArtDefineTag(int /*Mesh Index*/ i, int /*UnitType*/ j) const;
	DllExport void setIndustrialArtDefineTag(int /*Mesh Index*/ i, int /*UnitType*/ j, const TCHAR* szVal);
	DllExport const TCHAR* getFutureArtDefineTag(int /*Mesh Index*/ i, int /*UnitType*/ j) const;
	DllExport void setFutureArtDefineTag(int /*Mesh Index*/ i, int /*UnitType*/ j, const TCHAR* szVal);
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
public:
	...
	DllExport bool isMainInterfaceScreen();
	DllExport bool isCivicScreen();
	DllExport bool isCorporationScreen();
	DllExport bool isDomesticAdvisor();
	DllExport bool isEspionageAdvisor();
	DllExport bool isForeignAdvisor();
	DllExport bool isMilitaryAdvisor();
	DllExport bool isVictoryScreen();
	DllExport int getScreen();
...
//
//  DESC:   Contains info about cultural ages
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvCulturalAgeInfo : 
	public CvInfoBase
...
public:
	...
	CvCulturalAgeInfo();
	virtual ~CvCulturalAgeInfo();

	int getNumNextCulturalAges() const;
	CulturalAgeTypes getNextCulturalAge(int i) const;

	int getNumAgeSegments() const;
	CvWString getAgeSegmentDescription(int i) const;
	int getAgeSegmentDuration(int i) const;

	bool read(CvXMLLoadUtility* pXML);
	bool readPass2(CvXMLLoadUtility* pXML);

	void copyNonDefaults(CvCulturalAgeInfo* pClassInfo, CvXMLLoadUtility* pXML);
	void copyNonDefaultsReadPass2(CvCulturalAgeInfo* pClassInfo = NULL, CvXMLLoadUtility* pXML = NULL);

	void getCheckSum(unsigned int& iSum);

protected:

	std::vector<CulturalAgeTypes> m_aiNextCulturalAge;
	std::vector<CvWString> m_aAgeSegmentDescription;
	std::vector<int> m_aiAgeSegmentDuration;
};
