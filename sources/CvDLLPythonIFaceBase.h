...
#else
#define PYTHON_CALL_FUNCTION2(fn,x,y)		gDLL->getPythonIFace()->callFunction(x,y)
#define PYTHON_CALL_FUNCTION(fn,x,y,z)		gDLL->getPythonIFace()->callFunction(x,y,z)
#define PYTHON_CALL_FUNCTION4(fn,w,x,y,z)	gDLL->getPythonIFace()->callFunction(w,x,y,z)
#endif
