...
##### DCM START
		elif (CivilopediaPageTypes.CIVILOPEDIA_PAGE_CONCEPT_DCM == self.iCivilopediaPageType):
			iNum = gc.getNumDCMConceptInfos()
##### DCM END
##### Afforess START
		elif (CivilopediaPageTypes.CIVILOPEDIA_PAGE_CONCEPT_AND == self.iCivilopediaPageType):
			iNum = gc.getNumANDConceptInfos()
##### Afforess END
...
##### DCM START
			...
			info = gc.getDCMConceptInfo(iEntry)
##### DCM END
##### AND START
		elif (CivilopediaPageTypes.CIVILOPEDIA_PAGE_CONCEPT_AND == self.iCivilopediaPageType):
			info = gc.getANDConceptInfo(iEntry)
##### AND END
		elif (CivilopediaPageTypes.CIVILOPEDIA_PAGE_SPECIALIST == self.iCivilopediaPageType):
