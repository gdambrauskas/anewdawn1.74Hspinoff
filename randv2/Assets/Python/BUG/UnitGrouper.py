...
# RevDCM - AUA - start
			self.ORDER_AUTO_PILLAGE,
			self.ORDER_AUTO_HUNT,
			self.ORDER_AUTO_CITY_DEFENSE, 
			self.ORDER_BORDER_PATROL, 
			self.ORDER_AUTO_PIRATE, 
			self.ORDER_AUTO_AIRSTRIKE,
			self.ORDER_AUTO_AIRBOMB, 
			self.ORDER_AUTO_AIR_RECON, 
			self.ORDER_AUTO_SHADOW,
			self.ORDER_OTHER,
		) = range(27)
# RevDCM - AUA - end
...
# RevDCM - AUA - start
		self._addGroup(Group(self, self.ORDER_AUTO_PILLAGE, "TXT_KEY_UNIT_GROUPER_ORDER_GROUP_PILLAGESETTINGS"))
		self._addGroup(Group(self, self.ORDER_AUTO_HUNT, "TXT_KEY_UNIT_GROUPER_ORDER_GROUP_HUNTSETTINGS"))
		self._addGroup(Group(self, self.ORDER_AUTO_CITY_DEFENSE, "TXT_KEY_UNIT_GROUPER_ORDER_GROUP_DEFENSESETTINGS"))
		self._addGroup(Group(self, self.ORDER_BORDER_PATROL, "TXT_KEY_UNIT_GROUPER_ORDER_GROUP_PATROLSETTINGS"))
		self._addGroup(Group(self, self.ORDER_AUTO_PIRATE, "TXT_KEY_UNIT_GROUPER_ORDER_GROUP_PIRATESETTINGS"))
		self._addGroup(Group(self, self.ORDER_AUTO_AIRSTRIKE, "TXT_KEY_UNIT_GROUPER_ORDER_GROUP_AIRSTRIKESETTINGS"))
		self._addGroup(Group(self, self.ORDER_AUTO_AIRBOMB, "TXT_KEY_UNIT_GROUPER_ORDER_GROUP_AIRBOMBSETTINGS"))
		self._addGroup(Group(self, self.ORDER_AUTO_AIR_RECON, "TXT_KEY_UNIT_GROUPER_ORDER_GROUP_AIRUNITCANDEFEND_TEXT"))
		self._addGroup(Group(self, self.ORDER_AUTO_SHADOW, "TXT_KEY_UNIT_GROUPER_ORDER_GROUP_PROTECTSETTINGS"))
# RevDCM - AUA - end
