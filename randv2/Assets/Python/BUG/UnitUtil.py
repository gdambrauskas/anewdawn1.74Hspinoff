			...
			for city in PlayerUtil.playerCities(player):
				if askingPlayer:
					if not city.isRevealed(eAskingTeam, False):
						continue
					if city.canTrain(eUnit, False, not trade, False, False):
					...
					if city.canTrain(eUnit, False, False, False, False):
						units.add(eUnit)
						break
...
# RevDCM - AUA - start
	ORDER_AUTO_PILLAGE,
	ORDER_AUTO_HUNT,
	ORDER_AUTO_CITY_DEFENSE,
	ORDER_BORDER_PATROL,
	ORDER_AUTO_PIRATE,
	ORDER_AUTO_AIRSTRIKE,
	ORDER_AUTO_AIRBOMB,
	ORDER_AUTO_AIR_RECON,
	ORDER_AUTO_SHADOW,
) = range(26)
# RevDCM - AUA - end
...
# RevDCM - AUA - start
	AutomateTypes.AUTOMATE_PILLAGE: ORDER_AUTO_PILLAGE,
	AutomateTypes.AUTOMATE_HUNT: ORDER_AUTO_HUNT,
	AutomateTypes.AUTOMATE_CITY_DEFENSE: ORDER_AUTO_CITY_DEFENSE,
	AutomateTypes.AUTOMATE_BORDER_PATROL: ORDER_BORDER_PATROL,
	AutomateTypes.AUTOMATE_PIRATE: ORDER_AUTO_PIRATE,
	AutomateTypes.AUTOMATE_AIRSTRIKE: ORDER_AUTO_AIRSTRIKE,
	AutomateTypes.AUTOMATE_AIRBOMB: ORDER_AUTO_AIRBOMB,
	AutomateTypes.AUTOMATE_AIR_RECON: ORDER_AUTO_AIR_RECON,
	AutomateTypes.AUTOMATE_SHADOW: ORDER_AUTO_SHADOW,
# RevDCM - AUA - end
}
MOVE_TO_MISSIONS = [
