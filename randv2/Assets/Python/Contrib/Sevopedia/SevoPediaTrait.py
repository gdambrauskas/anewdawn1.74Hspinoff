...
class SevoPediaTrait:
	...
	def placeSpecial(self):
		...
		szText = CyGameTextMgr().parseTraits(self.iTrait, -1, False, True)[1:]
		screen.addMultilineText(listName, szText, self.X_SPECIAL+5, self.Y_SPECIAL+27, self.W_SPECIAL-10, self.H_SPECIAL-32, WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
