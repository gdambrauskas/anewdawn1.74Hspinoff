...
class SevoPediaFeature:
	...
	def __init__(self, main):
		...
		self.H_SPECIAL_PANE = 150#self.top.B_PEDIA_PAGE - self.Y_SPECIAL_PANE Roamty

		self.X_HISTORY_PANE = self.X_ICON_PANE
		self.Y_HISTORY_PANE = 446
		self.W_HISTORY_PANE = 598
		self.H_HISTORY_PANE = 256
	...
	def placeHistory(self):
		...
		panelName = self.top.getNextWidgetName()
		screen.addPanel( panelName, localText.getText("History", ()), "", True, True,
