...
# BUG - Colony Split - end
		...
		self.COLUMNS_LIST = [
				...
				("REVOLUTION_INDEX",		85,		"int",	CyCity.getRevolutionIndex,None,					0,									None,									None,						"localText.getText(\"REVOLUTION_INDEX_ADVISOR_SIMPLE\", ()).upper()"),
				("REVOLUTION_STATUS",		85,		"text",	self.getRevolutionStatusText,None,				0,									None,									None,						"localText.getText(\"TXT_KEY_REV_STATUS\", ()).upper()"),
				("LOCAL_REV_INDEX",			85,		"int",	CyCity.getLocalRevIndex,None,					0,									None,									None,						"localText.getText(\"LOCAL_REV_INDEX_ADVISOR_SIMPLE\", ()).upper()"),
				("DELTA_TREND",				85,		"int",	self.getDeltaTrendVal,	None,					0,									None,									None,						"localText.getText(\"DELTA_TREND_ADVISOR_SIMPLE\", ()).upper()"),
				("DELTA_TREND_TEXT",		85,		"text",	self.getDeltaTrendText,	None,					0,									None,									None,						"localText.getText(\"DELTA_TREND_ADVISOR_SIMPLE\", ()).upper()"),
